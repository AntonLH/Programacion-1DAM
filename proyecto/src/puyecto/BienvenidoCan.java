 ...
 * @author admin1
 */
public class BienvenidoCan extends javax.swing.JFrame {

    /**
     * Creates new form BienvenidoCan
     */
    public BienvenidoCan() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        RegisoInici.setText("Registrarse o inicie sesion");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(77, 77, 77)
                .addComponent(RegisoInici)
                .addGap(45, 45, 45)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(Registrarse, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(Identificarse, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void RegistrarseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegistrarseActionPerformed
        RegistrarseCan p=new RegistrarseCan();
            p.setVisible(true);
            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BienvenidoCan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BienvenidoCan().setVisible(true);
            }
        });
    }
